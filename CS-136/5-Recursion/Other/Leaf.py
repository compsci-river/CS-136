...
class Leaf:
    ...
    def recursiveDiamond(self,n,x,y,s,t,stage):
        ...
        if n > 0:
            if stage == 1:
                self.recursiveDiamond(n,xList[2],yList[2],s*5/6,t,1)
            else:
...
##        self.leaf(n,-size,-size,s*4/5,math.pi/4)
##        self.leaf(n,size,-size,s*4/5,3*math.pi/4)
##        self.leaf(n,size,size,s*4/5,5*math.pi/4)
##        self.leaf(n,-size,size,s*4/5,7*math.pi/4)
